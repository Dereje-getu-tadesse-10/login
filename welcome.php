...
<body>
    <main>
        ...
        <section class="right">
            ...
            <h1 class="sing-in">Welcome !</h1>
            <form method="POST">
                <div class="email">
                    <p>Congratulations, you are</p>
                    <p>part of the binary tribe !</p>
                </div>

                <div class="password">
                    <p>Take a look at our great blog</p>
                    <p>and read our latest articles.</p>
                </div>

                <button type="submit">Great blog</button>
            </form>
