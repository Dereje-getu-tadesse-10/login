...
<body>
  <main>
    <section class="left">
      <img src="./assets/background-purple-and-pink-letter-blocks-pattern-pattern-image.jpg" alt="art abstrait et block violet et bleu" />
    ...
    <section class="right">
      ...
      <form method="post" id="login">
        <div class="email">
          ...
          <input class="email-log" type="email" />
          <span></span>
        </div>

        <div class="password">
          <label for="password">password</label>
          <input class="password-log" type="password" />
          <span></span>
        </div>

        <button type="submit">Sing in</button>
        <p class="exist-not-exist"></p>
      </form>

      <hr />

      <p class="sing-up">
        Already don't have account ? <a href="sing-up.php">Sing up</a>
      </p>
    </section>
  </main>
